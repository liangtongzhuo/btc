# 前言
一直对区块链感兴趣，读了区块链的[白皮书](https://bitcoin.org/bitcoin.pdf)，然后查找了相关资料视频，有一位up主，时间过的久了忘记录视频的 Up 主是谁了。下面用简单的代码段来描述区块链，项目不包含 p2p 网络，仅是描述简单的区块链的全部过程，如果你对编程不太了解，不太建议你读。
